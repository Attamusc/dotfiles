...
| Sub-skill | Use when |
|-----------|----------|
| **[security-investigation](security-investigation/WORKFLOW.md)** | "Who changed X?", "What did this user do?", "Show me deletions in the last 24h" |
| **[key-compromise](key-compromise/WORKFLOW.md)** | "Was this API key compromised?", "What did key XYZ do?", "Investigate suspicious key activity" |
| **[cost-spike-investigation](cost-spike-investigation/WORKFLOW.md)** | "Why did my bill go up?", "What caused this usage spike?", "Investigate LLM cost increase" |
| **[compliance-report](compliance-report/WORKFLOW.md)** | "Generate SOC 2 evidence", "PCI audit log", "User provisioning report for auditor" |
| **[ai-activity-audit](ai-activity-audit/WORKFLOW.md)** | "What did the AI assistant do?", "Audit MCP tool calls", "AI governance report" |
