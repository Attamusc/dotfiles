...
**Immediately read** `k8s-ssi/agent-install/WORKFLOW.md` now, then `k8s-ssi/enable-ssi/WORKFLOW.md`, then `k8s-ssi/verify-ssi/WORKFLOW.md` — do not proceed from memory.
...
**Immediately read** `linux-ssi/agent-install/WORKFLOW.md` now, then `linux-ssi/enable-ssi/WORKFLOW.md`, then `linux-ssi/verify-ssi/WORKFLOW.md` — do not proceed from memory.
...
**Immediately read** `service-remapping/WORKFLOW.md` now — do not proceed from memory.
