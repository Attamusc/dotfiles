return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("BufEnter", {
        desc = "Format swoop keyboard",
        group = qmk_group,
        pattern = "*/swoop/*/keymap.c",
        callback = function()
          qmk.setup({
            name = "LAYOUT_split_3x5_3",
            auto_format_pattern = "*/swoop/*/keymap.c",
            layout = {
              "_ x x x x x _ _ _ x x x x x",
              "_ x x x x x _ _ _ x x x x x",
              "_ x x x x x _ _ _ x x x x x",
      ...
      vim.api.nvim_create_autocmd("BufEnter", {
        desc = "Format zmk toucan keyboard",
        group = qmk_group,
        pattern = "*/toucan.keymap",
        callback = function()
          qmk.setup({
            name = "layout",
            auto_format_pattern = "*/toucan.keymap",
            variant = "zmk",
            layout = {
              "_ x x x x x x _ _ _ x x x x x x",
              "_ x x x x x x _ _ _ x x x x x x",
